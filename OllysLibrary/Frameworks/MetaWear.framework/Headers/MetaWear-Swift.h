...
@interface MetaWear (SWIFT_EXTENSION(MetaWear)) <LoggerDelegate>
...
@interface MetaWear (SWIFT_EXTENSION(MetaWear)) <DFUServiceDelegate>
...
SWIFT_CLASS("_TtC8MetaWear18MockCentralManager")
@interface MockCentralManager : CBCentralManager
...
- (nonnull instancetype)initWithDelegate:(id <CBCentralManagerDelegate> _Nullable)delegate queue:(dispatch_queue_t _Nullable)queue options:(NSDictionary<NSString *, id> * _Nullable)options SWIFT_UNAVAILABLE;
@end
